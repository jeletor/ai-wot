...
const { publishAttestation, publishWorkCompleted, queryRelays, RELAYS } = require('./wot');
const { generateReceiptCandidate, parseDVMResult, watchDVMResults } = require('./receipts');
